...
const sections = [
  ...
  {
    title: "広告について",
    body: "当サイトは、Amazon.co.jpを宣伝しリンクすることによってサイトが紹介料を獲得できる手段を提供することを目的に設定されたアフィリエイトプログラムである、Amazonアソシエイト・プログラムの参加者です。当サイトの商品リンクにはアフィリエイトリンク（広告）が含まれます。「PR」「広告」と表記されたリンクを経由して商品を購入された場合、当サイトに紹介料が支払われることがあります。商品の価格や評価には一切影響しません。",
  },
  {
    title: "アクセス解析ツールについて",
