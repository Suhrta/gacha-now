...
const sections = [
  ...
  {
    title: "広告について",
    body: "当サイトは、楽天アフィリエイトをはじめとするアフィリエイトプログラムに参加しています。当サイトの商品リンクにはアフィリエイトリンク（広告）が含まれます。「PR」「広告」と表記されたリンクを経由して商品を購入された場合、当サイトに紹介料が支払われることがあります。商品の価格や評価には一切影響しません。また、Amazonのアソシエイトとして、ガチャなうは適格販売により収入を得ています。",
  },
  {
    title: "アクセス解析ツールについて",
  ...
  },
  {
    ...
    body: "当サイトでは、第三者配信の広告サービス「Google AdSense」を利用しています。広告配信事業者は、ユーザーの興味に応じた広告を表示するためにCookieを使用することがあります。Cookieを使用することで、当サイトはユーザーのブラウザを識別できるようになりますが、ユーザー個人を特定するものではありません。Cookieを無効にする方法や、Google AdSenseに関する詳細は「広告 – ポリシーと規約 – Google」をご確認ください。また、ユーザーはGoogleの広告設定でパーソナライズ広告を無効にできます。",
  },
  {
    title: "Cookieについて",
